...
namespace GamesDat.Core.Telemetry.Sources.Formula1.F12025
{
    ...
    {
        public ushort m_packetFormat;             // 2025
        public byte m_gameYear;                 // Game year - last two digits e.g. 25
        ...
        public uint m_overallFrameIdentifier;   // Overall identifier for the frame the data was retrieved on, doesn't go back after flashbacks
